...
#define FIREBALL_ANIMATION_FRAMES 5
#define PANDA_ANIMATION_FRAMES 3
#define TRAPDOOR_FRAMES 2
...
#define TOTAL_TILE_SPRITES 51
#define TRAPDOOR_SPRITES 1
#define TRAPDOOR_ANIMATION_FRAMES 2
enum tiles {
    TILE_FLOOR,
    TILE_WALL };
...
class printer {
    private:
        ...
        SDL_Rect camera_;
        SDL_Rect trap_clips_[TRAPDOOR_ANIMATION_FRAMES];
    public:
